...
### returns a list of all called functions in function.name
### eg. list_functions("<function_name>", recursive = FALSE)
### from: https://stackoverflow.com/questions/11872879/finding-out-which-functions-are-called-within-a-given-function

list_functions <- function(function.name, recursive = FALSE, 
